defmodule PhxOneSevenGrpcWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PhxOneSevenGrpcWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PhxOneSevenGrpcWeb.Gettext, "errors", msg, opts)
    end
  end
